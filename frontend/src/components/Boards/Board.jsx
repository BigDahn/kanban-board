    ...
    <section className="flex flex-col gap-[1em] md:gap-[1.6em] ">
      ...
      <div className="flex flex-col gap-[0.5em]">
        ...
        <div className="flex items-center gap-2  hover:bg-white py-4  px-[1.5em] md:py-[1em] rounded-tr-full rounded-br-full md:w-69 cursor-pointer dark:hover:bg-primary-100/25 dark:hover:text-primary-100">
          ...
          <CreateBoard
            className="flex gap-2  items-center justify-center rounded leading-none  outline-none outline-offset-1 capitalize text-primary-100 text-[15px] font-bold hover:bg-mauve3 focus-visible:outline-2 focus-visible:outline-violet6 select-none cursor-pointer dark:text-primary-100"
